    ...
    <section class="tw-container tw-relative tw-mx-auto xl:tw-px-0">
      ...
      <section class="tw-flex tw-h-screen tw-flex-col tw-align-middle">
        <div class="tw-relative tw-z-50 tw-mt-20 sm:tw-my-auto 2xl:tw-mt-40">
          <h1
              class="custom-text-gradient tw-font-display tw-text-6xl tw-transition-all dark:tw-from-lime-500 dark:tw-via-purple-400 dark:tw-to-amber-300 sm:tw-text-7xl xl:tw-text-8xl 2xl:-tw-mt-20 2xl:tw-text-9xl"
          >
          ...
          <h3
              class="tw-mt-10 tw-font-semibold dark:tw-text-orange-50 sm:tw-text-xl md:tw-max-w-2xl xl:tw-max-w-4xl xl:tw-text-3xl"
          >
            As a
            <a
                href="#about"
        ...
        <div
            aria-hidden="true"
            class="tw-absolute -tw-bottom-[15%] -tw-right-[25%] tw-h-128 tw-w-128 tw-rounded-full tw-border-[5px] tw-border-dotted tw-border-teal-300 tw-transition-all hover:tw-rotate-0 hover:tw-cursor-pointer motion-safe:tw-animate-spin-slow  dark:tw-border-indigo-900 dark:tw-bg-transparent lg:-tw-bottom-[18%] lg:-tw-right-[15%] lg:tw-h-[600px] lg:tw-w-[600px] "
        />
        <img
            class="custom-image-animation tw-relative tw-mx-auto tw-my-10 tw-w-2/4 sm:tw-absolute sm:-tw-bottom-52 sm:-tw-right-36 sm:tw-z-10 sm:tw-mt-16 sm:tw-w-96 lg:tw-w-1/3 xl:-tw-bottom-[25%] xl:-tw-right-40"
