    ...
    <div
      ...
      <div
        ...
        <div class="tw-w-full tw-text-center lg:tw-w-6/12">
          {{ $t('footer.info1') }}
          <a
            class="tw-rounded-md tw-bg-opacity-50 tw-px-1 tw-py-1 tw-text-indigo-800 tw-underline tw-underline-offset-4 tw-transition-colors hover:tw-bg-white focus-visible:tw-outline-none focus-visible:tw-ring-4 focus-visible:tw-ring-purple-300 dark:tw-text-purple-50 dark:hover:tw-bg-black"
            href="//www.vuejs.org"
            title="Vue.js 3"
          >Vue.js</a
          >
        ...
        <div class="tw-mt-10 tw-w-full tw-text-center lg:tw-mt-0 lg:tw-w-4/12 lg:tw-text-right">
          ...
          <router-link
            to="/datenschutz"
            class="tw-rounded-md tw-bg-opacity-50 tw-px-2 tw-py-1 tw-text-indigo-800 tw-underline tw-underline-offset-4 tw-transition-colors hover:tw-bg-white focus-visible:tw-outline-none focus-visible:tw-ring-4 focus-visible:tw-ring-purple-300 dark:tw-text-purple-50 dark:hover:tw-bg-black">
            {{ $t('footer.privacy') }}
          </router-link>
        </div>
      </div>
