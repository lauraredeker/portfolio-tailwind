      ...
      >
        ...
        >
          <span class="tw-flex tw-flex-row tw-items-center tw-justify-start tw-align-middle">
            <span
              aria-hidden="true"
              class="tw-i-ph-coffee-light tw-mr-4 tw-hidden tw-h-10 tw-w-10 tw-text-indigo-500 dark:tw-text-purple-400 md:tw-inline-block md:tw-h-12 md:tw-w-12 xl:tw-mr-12 xl:tw-h-20 xl:tw-w-20"
            />
            <h3
