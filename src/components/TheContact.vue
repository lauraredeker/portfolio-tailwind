<template>
    <section class="tw-flex tw-h-screen tw-flex-col tw-items-center tw-justify-center">
      <div class="tw-container tw-mx-auto tw-text-center md:tw-w-3/5">
        ...
        <p class="tw-mb-2 tw-mt-6 tw-text-center tw-text-xl tw-font-medium md:tw-mt-20 md:tw-text-xl">
