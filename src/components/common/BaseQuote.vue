  ...
  <div>
    ...
    >
      ...
      >
        ...
        <cite
          class="tw-mt-10 tw-block tw-text-sm tw-font-semibold tw-not-italic tw-tracking-normal tw-text-white tw-drop-shadow-sm dark:tw-text-gray-300 sm:tw-text-base md:tw-mt-10 md:tw-text-l 2xl:tw-text-xl"
        >
