...
<template>
  <div
    ...
    class="tw-mx-auto tw-mb-10 tw-max-w-full md:tw-mb-40 md:tw-p-8 2xl:tw-w-3/4 3xl:tw-w-4/6"
  >
    <blockquote
      :class="{
      ...
      class="tw-mb-4 tw-hyphens-auto tw-border-l-[10px] tw-bg-indigo-200 tw-bg-opacity-40 tw-px-8 tw-py-10 tw-text-l tw-font-semibold tw-leading-tight tw-text-indigo-900 dark:tw-border-purple-600 dark:tw-bg-indigo-800 dark:tw-bg-opacity-40 dark:tw-text-indigo-300 sm:tw-p-10 sm:tw-text-xl md:tw-mb-10 md:tw-border-l-[20px] md:tw-border-amber-400 md:tw-px-20 md:tw-py-10 md:tw-text-2xl md:tw-text-indigo-700 lg:tw-text-3xl xl:tw-text-4xl 3xl:tw-text-5xl"
    >
      <span
        class="tw-i-ph-quotes-duotone tw-mr-2 tw-inline-block tw-text-2xl md:tw-text-3xl xl:tw-text-5xl"
        aria-hidden="true"
      />
      {{ $t('about.testimonial') }}
      <cite
