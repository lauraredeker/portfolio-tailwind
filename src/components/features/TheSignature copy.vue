...
<template>
  <svg
    ...
    <g id="laura-signature">
      ...
      <path
        id="A_00000160886715073203072090000009521762371783562135_"
        class="font"
    ...
    <g id="mask">
      <path
        id="mask-L"
        class="st1"
        d="M59.96,5c0,0-12.46,85.5-54.04,118.53c-1.55,1.23-3.67,0.13-2.88-1.69
		c2.75-6.34,15.52-21.23,37.09-21.23c37.24,0,61.85-40.04,62.48-39.42" />
      <path
        id="mask-A_00000160150705048922119220000010188991627531606926_"
        class="st1"
        d="M115.9,65.49
		c-2.23,4.29-16.22,22.55-11.97,7.98s11.97-6.34,11.97-6.34s-11.19,34.32,19.01,2.45" />
      <path
        id="mask-U"
        class="st1"
        d="M136.41,67.16c0,0-23.11,44.33,10.33,5.76c0,0,1.08-0.4,2.17,10.71c0,0,15.13-8.89,17.36-12.01" />
      <path
        id="mask-R"
        class="st1"
        d="M164.66,72.51c1.05-0.98,2.14-2.06,3.25-3.25c10.6-11.42-6.61-6.67-4.71-0.66
		c0,0,6.63,1.18,8.52,9.36c0.14,0.62,0.15,1.26,0.1,1.9c-0.22,2.8-0.3,10.97,6.69,8.17c8.39-3.35,16.36-13.29,19.92-22.58" />
      <path
        id="mask-AA"
        class="st1"
        d="M207.03,66.22c-2.6-1.45-10.46-5.45-11.82,11.7c0,0,1.76,3.39,10.14-6.67c0,0,2.55-1.1,3.35-3.35
		C208.89,67.4,207.5,66.48,207.03,66.22z" />
      <path
        id="mask-AAend"
        class="st1"
        d="M208.71,67.9c0,0-13.72,31.84,17.54,3.72l1.52-2.18" />
    </g>
  </svg>
</template>
